...
router.post("/", async (req, res) => {
  try {
    ...
    try {
      ...
      // إذا فشل التحقق من الإعدادات نُكمل — خطأ في قراءة الإعداد لا يجب أن يمنع الطلب
      console.error('⚠️ فشل التحقق من حالة المتجر:', settingsErr);
    }
    ...
    // بث إشعار الطلب الجديد عبر WebSocket للإدارة والمطعم
    try {
